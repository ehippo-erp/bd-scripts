--------------------------------------------------------
--  DDL for Trigger ANTES_INSERTAR_ASISTENCIA_PLANILLA
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "USR_TSI_SUITE"."ANTES_INSERTAR_ASISTENCIA_PLANILLA" BEFORE
    INSERT ON "USR_TSI_SUITE"."ASISTENCIA_PLANILLA"
    FOR EACH ROW
DECLARE
...
/
ALTER TRIGGER "USR_TSI_SUITE"."ANTES_INSERTAR_ASISTENCIA_PLANILLA" ENABLE;
