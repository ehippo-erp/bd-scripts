--------------------------------------------------------
--  DDL for Function SP_DETALLE_SALDO_ENTREGADO
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "USR_TSI_SUITE"."SP_DETALLE_SALDO_ENTREGADO" (
    pin_id_cia NUMBER,
    pin_numint NUMBER
...
AS
    ...
    FROM
        ...
        LEFT OUTER JOIN titulolista    t ON t.id_cia = pin_id_cia
...
BEGIN
    ...
    END LOOP;
END sp_detalle_saldo_entregado;
