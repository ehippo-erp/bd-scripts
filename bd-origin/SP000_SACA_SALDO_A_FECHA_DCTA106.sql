--------------------------------------------------------
--  DDL for Function SP000_SACA_SALDO_A_FECHA_DCTA106
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "USR_TSI_SUITE"."SP000_SACA_SALDO_A_FECHA_DCTA106" (
    pin_id_cia  NUMBER,
    pin_numint  NUMBER,
    pin_fecha   DATE
