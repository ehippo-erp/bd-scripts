--------------------------------------------------------
--  DDL for Package Body PACK_HR_AFP
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "USR_TSI_SUITE"."PACK_HR_AFP" AS
    ...
    IS
        ...
        FROM
            ...
            LEFT OUTER JOIN pcuentas              p ON p.id_cia = a.id_cia
                                          AND p.cuenta = a.codcta
        WHERE
                a.id_cia = pin_id_cia
