--------------------------------------------------------
--  DDL for Package PACK_PROV103
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "USR_TSI_SUITE"."PACK_PROV103" AS
    TYPE datarecord_prov103 IS RECORD (
        ...
        doc_tipdoc_abrevi  tdocume.abrevi%TYPE,
        doc_signo          tdocume.signo%TYPE,
        doc_tipdoc        prov100.tipdoc%TYPE,
