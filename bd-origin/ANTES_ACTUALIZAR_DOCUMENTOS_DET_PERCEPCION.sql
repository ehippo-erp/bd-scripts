--------------------------------------------------------
--  DDL for Trigger ANTES_ACTUALIZAR_DOCUMENTOS_DET_PERCEPCION
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "USR_TSI_SUITE"."ANTES_ACTUALIZAR_DOCUMENTOS_DET_PERCEPCION" BEFORE
    UPDATE ON "USR_TSI_SUITE".documentos_det_percepcion
    FOR EACH ROW
DECLARE
    v_numite  NUMBER;
...
/
ALTER TRIGGER "USR_TSI_SUITE"."ANTES_ACTUALIZAR_DOCUMENTOS_DET_PERCEPCION" ENABLE;
