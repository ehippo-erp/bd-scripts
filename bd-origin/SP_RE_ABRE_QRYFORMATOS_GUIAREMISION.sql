--------------------------------------------------------
--  DDL for Function SP_RE_ABRE_QRYFORMATOS_GUIAREMISION
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "USR_TSI_SUITE"."SP_RE_ABRE_QRYFORMATOS_GUIAREMISION" (
...
--            LEFT OUTER JOIN sp_select_articulo_clase(d.id_cia, d.tipinv, d.codart, 81)       ac1 ON 0 = 0
            LEFT OUTER JOIN sp_select_articulo_clase(d.id_cia, d.tipinv, d.codart, 87)       Ac2 ON 0 = 0
--            LEFT OUTER JOIN sp_select_articulo_clase(d.id_cia, d.tipinv, d.codart, 74)       cc3 ON 0 = 0
--            LEFT OUTER JOIN sp_select_articulo_clase(d.id_cia, d.tipinv, d.codart, 2)        acc2 ON acc2.codigo <> 'ND'
--            LEFT OUTER JOIN sp_select_articulo_clase(d.id_cia, d.tipinv, d.codart, 3)        acc3 ON acc3.codigo <> 'ND'
--            LEFT OUTER JOIN sp_select_articulo_clase(d.id_cia, d.tipinv, d.codart, 51)       acc51 ON acc51.codigo <> 'ND'
--            LEFT OUTER JOIN sp_select_articulo_clase(d.id_cia, d.tipinv, d.codart, 97)       acc97 ON acc97.codigo <> 'ND'
...
--                                            AND ( s2.tipdoc = c.tipdoc )
    ...
    RETURN;
END sp_re_abre_qryformatos_guiaremision;
