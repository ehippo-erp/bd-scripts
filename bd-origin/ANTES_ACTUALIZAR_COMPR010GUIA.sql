--------------------------------------------------------
--  DDL for Trigger ANTES_ACTUALIZAR_COMPR010GUIA
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "USR_TSI_SUITE"."ANTES_ACTUALIZAR_COMPR010GUIA" BEFORE
    UPDATE ON "USR_TSI_SUITE".compr010guia
    FOR EACH ROW
DECLARE
    v_serie   VARCHAR2(5);
...
END;
/
ALTER TRIGGER "USR_TSI_SUITE"."ANTES_ACTUALIZAR_COMPR010GUIA" ENABLE;
