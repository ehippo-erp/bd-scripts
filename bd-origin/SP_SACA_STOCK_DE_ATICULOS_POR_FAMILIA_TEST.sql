--------------------------------------------------------
--  DDL for Function SP_SACA_STOCK_DE_ATICULOS_POR_FAMILIA_TEST
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "USR_TSI_SUITE"."SP_SACA_STOCK_DE_ATICULOS_POR_FAMILIA_TEST" (
...
/*
	...
	*/
	RETURN v_sqlselect;
END sp_saca_stock_de_aticulos_por_familia_test;
