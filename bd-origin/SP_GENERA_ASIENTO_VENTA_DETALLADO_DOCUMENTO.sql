--------------------------------------------------------
--  DDL for Procedure SP_GENERA_ASIENTO_VENTA_DETALLADO_DOCUMENTO
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "USR_TSI_SUITE"."SP_GENERA_ASIENTO_VENTA_DETALLADO_DOCUMENTO" (
...
BEGIN
    ...
    FOR i IN cur_gen_asiento_det LOOP
        ...
        r_asiendet.razon := substr(i.razonc,1,74);
...
END sp_genera_asiento_venta_detallado_documento;
