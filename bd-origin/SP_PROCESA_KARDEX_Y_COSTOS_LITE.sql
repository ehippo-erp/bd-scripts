--------------------------------------------------------
--  DDL for Procedure SP_PROCESA_KARDEX_Y_COSTOS_LITE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "USR_TSI_SUITE"."SP_PROCESA_KARDEX_Y_COSTOS_LITE" (
...
END sp_procesa_kardex_y_costos_lite;
